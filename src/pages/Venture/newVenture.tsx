  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-teal-50 via-blue-50 to-purple-50 flex items-center justify-center px-4 py-12 relative overflow-hidden">
        ...
        <div 
          className="relative w-full max-w-2xl bg-white/90 backdrop-blur-xl border border-white/50 shadow-2xl rounded-2xl p-10 md:p-14"
          style={{ animation: 'fadeInUp 0.8s ease-out' }}
        >
          {/* Header with icon */}
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-teal-500 via-blue-500 to-purple-500 rounded-2xl shadow-lg mb-5">
              <svg className="w-9 h-9 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
              </svg>
            </div>
            <h1 className="text-4xl font-bold bg-gradient-to-r from-teal-600 via-blue-600 to-purple-600 bg-clip-text text-transparent mb-3">
              Start a New Venture
            </h1>
            <p className="text-gray-500 text-lg">Give your new business a name to begin your entrepreneurial journey</p>
          </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full py-4 rounded-2xl border-2 border-gray-200 focus:border-teal-400 focus:ring-4 focus:ring-teal-100 focus:outline-none transition-all duration-300 text-lg bg-white/80 backdrop-blur-sm disabled:bg-gray-100 disabled:cursor-not-allowed ${aiGeneratedIdea ? 'pl-6 pr-36' : 'px-6'}`}
                />
                {aiGeneratedIdea && (
                  <span
                    key={aiGeneratedIdea}
                    className="absolute right-4 top-1/2 -translate-y-1/2 inline-flex items-center gap-1.5 bg-gradient-to-r from-teal-500 to-blue-500 text-white text-sm px-3 py-1.5 rounded-full shadow-sm"
                    style={{ animation: 'badgePop 0.4s ease-out' }}
                  >
                    AI Suggested ✨
                  </span>
                )}
            ...
            <button
              ...
              className="w-full py-4 px-6 bg-gradient-to-r from-teal-50 to-blue-50 hover:from-teal-100 hover:to-blue-100 border-2 border-dashed border-teal-300 hover:border-teal-400 rounded-2xl transition-all duration-300 group disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <div className="flex items-center justify-center gap-3">
                {loadingIdea ? (
                  <>
                    ...
                    <span className="font-semibold text-base text-teal-700">Generating AI Idea...</span>
                  </>
                ) : (
                  <>
                    ...
                    <span className="font-semibold text-base text-teal-700">Need Inspiration? Get AI Business Idea</span>
            ...
            <button
              ...
              className={`group relative w-full py-4 rounded-2xl font-bold text-lg transition-all duration-300 overflow-hidden ${
                status === 'loading' || !title.trim()
                  ...
                  : 'bg-gradient-to-r from-teal-500 via-blue-500 to-purple-500 hover:from-teal-600 hover:via-blue-600 hover:to-purple-600 text-white shadow-lg hover:shadow-xl'
              }`}
            >
              {status === 'loading' ? (
            ...
            <div className="text-center pt-2">
              <button
                ...
                className="inline-flex items-center gap-2 text-gray-500 hover:text-teal-600 transition-colors group text-base"
              >
