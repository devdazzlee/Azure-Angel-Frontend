...
export const getPrivacyContent = (): string => {
  return `
    ...
    <ul style="padding-left: 1.5rem; line-height: 1.8;">
      ...
      <li><strong>Communications:</strong> If you contact us for support or feedback, we collect the information you provide in those correspondences (email address, the content of your message, etc.). We also retain your responses to any surveys or questionnaires (like our initial Get to Know You (GKY) onboarding questionnaire) that help us tailor Founderport's guidance to you.</li>
    </ul>
