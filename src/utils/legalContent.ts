...
export const getTermsContent = (): string => {
  return `
    ...
    <p>These Terms and Conditions govern the User Experience Agreement between you the User (in this Agreement hereinafter referred to as either "you," "your," "client," "contributor," "customer," and/or "user"), and Founderport Corporation, (in this agreement hereinafter referred to as either "Founderport Corporation," "Founderport," "Company," " we", "us" the Tool, or "our") and applies to your use of the Founderport Corporation, Founderport Corporation platform and Tool. This Agreement is applicable to registered members, as well as any visitor or user who uses the Tool in any way, shape or form. By utilizing this Tool, you hereby to abide by these Terms and Conditions and waive any objections to these Terms and Conditions.</p>
    
    <p><strong>Further, by opening an account or accessing the Founderport Corporation and Founderport Corporation Tool, you agree to the following Terms:</strong></p>
    ...
    <div style="background-color: #fef3c7; border-left: 4px solid #f59e0b; padding: 1rem; margin: 1.5rem 0;">
      <p style="font-weight: bold; margin: 0;"><strong>YOU FURTHER AGREE THAT ANY DISPUTES BETWEEN YOU AND FOUNDERPORT CORPORATION WILL BE RESOLVED BY BINDING, INDIVIDUAL ARBITRATION AND YOU WAIVE YOUR RIGHT TO PARTICIPATE IN A CLASS ACTION LAWSUIT OR CLASS-WIDE ARBITRATION. IF YOU DO NOT AGREE TO ABIDE BY ALL OF THE TERMS AND CONDITIONS CONTAINED THEREIN, PLEASE DO NOT USE THIS SITE.</strong></p>
    </div>
    
    <h3 style="font-size: 1.25rem; font-weight: bold; margin-top: 2rem; margin-bottom: 1rem; color: #0d9488;">User Representations and Covenants</h3>
    <p>In addition to any other representations and warranties contained within these Terms and Conditions, User further represents and warrants:</p>
    ...
    <h3 style="font-size: 1.25rem; font-weight: bold; margin-top: 2rem; margin-bottom: 1rem; color: #0d9488;">User Confidentiality and Protection</h3>
    <p>You are responsible for maintaining the confidentiality and security of your information and accept responsibility for all activities that occur under your account.</p>
    
    <h3 style="font-size: 1.25rem; font-weight: bold; margin-top: 2rem; margin-bottom: 1rem; color: #0d9488;">Intellectual Property</h3>
    <p>The content and information on this Tool are the property of Founderport Corporation. The content may not be downloaded, reproduced, for any use other than individual use.</p>
    <ul style="padding-left: 1.5rem; line-height: 1.8;">
      <li>All intellectual property rights including but not limited to texts, graphics, logos, images, audio clips, data compilations, scripts, software, technology, sound or any other materials or works found in the Tool belongs to Founderport Corporation.</li>
      <li>All graphics, animations, texts and other content, including functionality, distribution and location of specific elements used on Tool are law protected copyright works.</li>
      <li>No part of the Tool may be copied, distributed, adapted, modified, reproduced, republished, displayed, broadcasted or transmitted in any manner or by any means, any part of the Tool without written permission.</li>
      <li>Nothing in these Terms and Conditions grants you or any other person or entity any legal rights to Founderport Corporation and Founderport Corporation's Tool, other than as necessary to enable access. You agree not to adjust or try to circumvent or delete any notices contained on the Tool (including any Intellectual Property notices) and in particular any digital rights or other security embedded or contained within the Tool.</li>
    </ul>
    
    <h3 style="font-size: 1.25rem; font-weight: bold; margin-top: 2rem; margin-bottom: 1rem; color: #0d9488;">Limitation of Liability</h3>
    <p>In no event shall Founderport Corporation be liable whether in an action in negligence, contract or tort based on a warranty or otherwise for any damage, loss, expense or costs of any kind (including loss of profits, revenue, or loss or inaccuracy of data), whether direct or indirect, incidental, punitive, special, consequential or economic, even if Founderport Corporation's actions factored as a possible direct or indirect cause, or arising from or in connection with, but not limited to the following:</p>
    <ul style="padding-left: 1.5rem; line-height: 1.8;">
    ...
    <h3 style="font-size: 1.25rem; font-weight: bold; margin-top: 2rem; margin-bottom: 1rem; color: #0d9488;">Disclaimers</h3>
    <p>The contents of the Tool are provided on an "as is" and "as available" basis without warranties of any kind and are made available for your general information only. No warranty of any kind, express, implied or statutory, is given in conjunction with the contents of the Tool, the tools contained in the Tool or the Tool in general.</p>
    <p>Founderport Corporation does not warrant the accuracy, adequacy, completeness, reliability, timeliness, non-infringement, title, merchantability or fitness for any purpose of the information on the Tool or that the information available on the Tool will be uninterrupted or error-free, or other harmful effects, or that defects.</p>
    <p>Founderport Corporation does not guarantee the confidentiality or privacy of any communication or information transmitted on the Tool or any site linked to the Tool. We will not be liable for the privacy or security of information, e-mail addresses, registration and identification information, storage space, communications, confidential or proprietary information, or any other content transmitted over networks accessed by the site, or otherwise connected with your use of the Tool.</p>
    
    <h3 style="font-size: 1.25rem; font-weight: bold; margin-top: 2rem; margin-bottom: 1rem; color: #0d9488;">Final provisions</h3>
    <ol style="padding-left: 1.5rem; line-height: 1.8;">
    ...
    <h3 style="font-size: 1.25rem; font-weight: bold; margin-top: 2rem; margin-bottom: 1rem; color: #0d9488;">Angel AI Assistant Coverage</h3>
    <p>Angel is an AI-powered assistant and product feature of Founderport Corporation. By using Angel, you agree that:</p>
    <ol style="padding-left: 1.5rem; line-height: 1.8;">
...
export const getPrivacyContent = (): string => {
  return `
    ...
    <p><strong>Effective Date: 11.30.2025</strong></p>
    
    <h3 style="font-size: 1.25rem; font-weight: bold; margin-top: 1.5rem; margin-bottom: 1rem; color: #0d9488;">Introduction</h3>
    <p>Founderport, Inc. ("Founderport," "we," "us," or "our") is a California-based technology company offering an AI-driven entrepreneurial support tool called Founderport. We are committed to protecting your privacy and complying with applicable data protection laws in the United States and internationally. This Privacy Policy explains what information we collect from users ("you" or "user"), how we use and share it, and your rights regarding that information. Founderport primarily serves U.S. customers but welcomes a global user base, and we adhere to major privacy laws including the EU General Data Protection Regulation (GDPR) and California Consumer Privacy Act/California Privacy Rights Act (CCPA/CPRA), among others. Our platform is intended for adults (18 years and older) and is not directed at children or minors. By using Founderport or any Founderport services, you agree to the practices described in this policy. We encourage you to read it carefully and contact us with any questions.</p>
    
    <h3 style="font-size: 1.25rem; font-weight: bold; margin-top: 1.5rem; margin-bottom: 1rem; color: #0d9488;">Information We Collect</h3>
    <p>We collect both personal information and business-related information from you to provide and improve our services. This includes:</p>
    <ul style="padding-left: 1.5rem; line-height: 1.8;">
      <li><strong>Personal Identifiers:</strong> Your name and contact details (such as email address and login credentials). We also collect basic location information (e.g. city, state, country) to tailor service provider recommendations to your region.</li>
      <li><strong>Demographic Details:</strong> Your age (date of birth or age range) and other profile information such as education level and professional experience. This helps Founderport customize advice based on your background. We only allow users 18 or older, and do not intentionally collect data from anyone under 18 (see Children's Privacy below).</li>
      <li><strong>Business Information:</strong> Details about your business ideas, plans, and entrepreneurial goals that you choose to share with Founderport. This can include descriptions of your proposed products or services, business strategies, and any other information you input into the platform about your startup or project. We understand these ideas may be sensitive, and we treat them as confidential user data.</li>
      <li><strong>Usage Data:</strong> Information about how you interact with our platform. This includes technical data like your IP address, device type, browser type, and operating system, as well as logs of your activities within Founderport (e.g. pages or features used, timestamps, error reports). We may also collect information via cookies and similar technologies (see Cookies and Tracking below), such as your preferences and browsing actions on our site. This usage data helps us secure the service and improve user experience.</li>
      <li><strong>Third-Party Integrations:</strong> If you choose to connect Founderport with external services (for example, in the future connecting to accounting software or e-commerce platforms), we may receive information from those services with your permission. We will inform you and obtain consent when such integrations involve transferring your personal data.</li>
      <li><strong>Communications:</strong> If you contact us for support or feedback, we collect the information you provide in those correspondences (email address, the content of your message, etc.). We also retain your responses to any surveys or questionnaires (like our initial Know Your Customer (KYC) onboarding questionnaire) that help us tailor Founderport's guidance to you.</li>
    </ul>
    <p>We collect most information directly from you. In some cases, we may collect data automatically (e.g. via cookies) or from third parties (for example, if we add features to import data from social profiles or partner services, with your consent). We will only collect and process personal information that is adequate, relevant, and limited to what is necessary in relation to the purposes described in this policy, consistent with principles of data minimization under GDPR.</p>
    
    <h3 style="font-size: 1.25rem; font-weight: bold; margin-top: 1.5rem; margin-bottom: 1rem; color: #0d9488;">How We Use Your Information</h3>
    <p>Founderport uses the collected information to operate, provide, and improve the Founderport platform and related services. The primary purposes for which we use your personal and business information include:</p>
    <ul style="padding-left: 1.5rem; line-height: 1.8;">
    ...
    <ul style="padding-left: 1.5rem; line-height: 1.8;">
      ...
      <li><strong>Business Transfers:</strong> If Founderport undergoes a business transaction such as a merger, acquisition by another company, reorganization, or sale of all or part of its assets, user information (which is one of our business assets) may be transferred to the successor entity.</li>
    </ul>
    <p><strong>No Sale of Personal Information:</strong> Founderport does not sell your personal information to third parties for monetary value. In the context of U.S. privacy laws, "sale" can include certain data sharing. We want to clarify that any data sharing we do is either (a) with service providers under strict data use contracts, or (b) in anonymized form with partners, or (c) at your direct request – none of which constitutes selling your data for profit.</p>
    
    <h3 style="font-size: 1.25rem; font-weight: bold; margin-top: 1.5rem; margin-bottom: 1rem; color: #0d9488;">Cookies and Tracking Technologies</h3>
    <p><strong>What Are Cookies?</strong> Cookies are small text files stored on your device by websites you visit. We, and our third-party analytics and advertising partners, use cookies and similar technologies (such as web beacons and local storage) to ensure our platform functions properly, to analyze usage, and to personalize your experience.</p>
    ...
    <p><strong>Cookie Consent and Your Choices:</strong> In jurisdictions that require it (such as the EU/EEA under the GDPR), we will obtain your consent before using non-essential cookies on our site. You can change your cookie preferences at any time by adjusting the settings in that banner (if available) or by modifying your browser settings.</p>
    
    <h3 style="font-size: 1.25rem; font-weight: bold; margin-top: 1.5rem; margin-bottom: 1rem; color: #0d9488;">Data Storage and Retention</h3>
    <p><strong>Data Storage Locations:</strong> Founderport is headquartered in the United States, and the personal data we collect is primarily stored and processed on secure servers located in the U.S. We may use reputable cloud service providers to host our application and data (for example, AWS or Azure data centers in the U.S.).</p>
    <p><strong>Security Measures:</strong> We maintain appropriate technical and organizational security measures to protect your personal data against unauthorized access, disclosure, alteration, or destruction. This includes using encryption in transit and at rest, firewalls, secure network architectures, access controls, and data segregation.</p>
    <p><strong>Data Retention Period:</strong> We will retain your personal data only for as long as necessary to fulfill the purposes we collected it for, including for the purposes of providing the service and satisfying any legal, accounting, or reporting requirements.</p>
    
    <h3 style="font-size: 1.25rem; font-weight: bold; margin-top: 1.5rem; margin-bottom: 1rem; color: #0d9488;">International Data Transfers</h3>
    <p>Founderport's users are global, so your personal information may be transferred to, and processed in, countries other than your country of residence. Primarily, data is collected and stored in the United States. If you reside outside the U.S., this means your data will likely be transferred to the U.S. for processing. The U.S. may not have the same level of data protection laws as those in your home country, but please be assured that we take steps to protect your privacy in line with this Policy and applicable law.</p>
    
    <h3 style="font-size: 1.25rem; font-weight: bold; margin-top: 1.5rem; margin-bottom: 1rem; color: #0d9488;">Your Rights and Choices</h3>
    <p>You have important privacy rights regarding the personal information we hold about you. Founderport is committed to honoring your rights under applicable data protection laws such as GDPR and CCPA/CPRA. Depending on your jurisdiction, these rights may include:</p>
    <ul style="padding-left: 1.5rem; line-height: 1.8;">
      ...
      <li><strong>Right to Data Portability:</strong> You have the right to obtain your personal data in a structured, commonly used, and machine-readable format.</li>
      <li><strong>Right to Restrict or Object to Processing:</strong> Under GDPR, you can request that we restrict processing of your data in certain circumstances.</li>
      <li><strong>Right to Withdraw Consent:</strong> In cases where we rely on your consent to process personal data, you have the right to withdraw that consent at any time.</li>
    ...
    <p>You may exercise any of the above rights by contacting us using the information provided in the Contact Us section. For certain requests (access, deletion, etc.), we will need to verify your identity to ensure we are protecting your information from unauthorized access or deletion by someone else.</p>
    
    <h3 style="font-size: 1.25rem; font-weight: bold; margin-top: 1.5rem; margin-bottom: 1rem; color: #0d9488;">Children's Privacy</h3>
    <p>Founderport is not intended for individuals under the age of 18. We do not knowingly solicit or collect personal information from children or teenagers under 18 years old. Our platform is designed for adult entrepreneurs and requires users to attest that they are 18 or older during the account registration process. If you are under 18, you should not use the Founderport platform or provide any personal information to us.</p>
    
    <h3 style="font-size: 1.25rem; font-weight: bold; margin-top: 1.5rem; margin-bottom: 1rem; color: #0d9488;">Changes to This Policy</h3>
    <p>We may update or modify this Privacy Policy from time to time to reflect changes in our business, legal or regulatory requirements, or to address new features and data practices. When we make changes, we will post the updated policy on our website and change the "Last Updated" or "Effective Date" at the top of this policy.</p>
